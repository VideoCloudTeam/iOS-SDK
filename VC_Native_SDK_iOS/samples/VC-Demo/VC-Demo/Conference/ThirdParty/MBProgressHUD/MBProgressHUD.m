...
- (void)show:(BOOL)animated {
	...
	if (self.graceTime > 0.0 && ( [UIDevice currentDevice].systemVersion.doubleValue >= 10.0)) {
...
- (void)hide:(BOOL)animated {
	...
	if (self.minShowTime > 0.0 && showStarted && ( [UIDevice currentDevice].systemVersion.doubleValue >= 10.0)) {
