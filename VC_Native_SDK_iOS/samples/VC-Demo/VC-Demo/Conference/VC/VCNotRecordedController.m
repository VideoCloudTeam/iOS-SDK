...
@interface VCNotRecordedController ()<UIScrollViewDelegate>
...
@implementation VCNotRecordedController
...
- (UIView *)alertView {
  if (!_alertView) {
    ...
    NSAttributedString *text1 = [self jointAttributedStringWithItems:@[[self normorContent:NSLocalizedString(@"VCShareWithTypeSR1A", nil)],[self importContent:NSLocalizedString(@"VCShareWithTypeSR1B", nil)]]];
    NSAttributedString *text2 = [self jointAttributedStringWithItems:@[[self normorContent:NSLocalizedString(@"VCShareWithTypeSR2A", nil)],[self importContent:NSLocalizedString(@"VCShareWithTypeSR2B", nil)]]];
    NSAttributedString *text3 = [self jointAttributedStringWithItems:@[[self normorContent:NSLocalizedString(@"VCShareWithTypeSR3A", nil)],[self importContent:NSLocalizedString(@"VCShareWithTypeSR3B", nil)]]];
    NSAttributedString *text4 = [self jointAttributedStringWithItems:@[[self normorContent:NSLocalizedString(@"VCShareWithTypeSR4A", nil)],[self imageContent:[UIImage imageNamed:@"icon_screen_add"]],[self normorContent:NSLocalizedString(@"VCShareWithTypeSR4B", nil)],[self importContent:NSLocalizedString(@"VCShareWithTypeSR4C", nil)]]];
    [_alertView addSubview:[self addShowTextView:NSLocalizedString(@"VCShareWithTypeSRA", nil) andText1:text1 andText2:text2 andText3:text3 andText4:text4 showNext:YES]];
...
-(UIView *)showView{
  if(!_showView) {
    ...
    NSAttributedString *text1 = [self jointAttributedStringWithItems:@[[self normorContent:NSLocalizedString(@"VCShareWithTypeSR5", nil)]]];
    NSAttributedString *text2 = [self jointAttributedStringWithItems:@[[self normorContent:NSLocalizedString(@"VCShareWithTypeSR6", nil)],[self imageContent:[UIImage imageNamed:@"icon_screen_anniu"]]]];
    NSAttributedString *text3 = [self jointAttributedStringWithItems:@[[self normorContent:[NSString stringWithFormat:@"%@%@%@", NSLocalizedString(@"VCShareWithTypeSR7", nil),app_Name,NSLocalizedString(@"VCxuzhong", nil)]]]];
    NSAttributedString *text4 = [self jointAttributedStringWithItems:@[[self normorContent:NSLocalizedString(@"VCShareWithTypeSR8", nil)]]];
    
    [_showView addSubview:[self addShowTextView:NSLocalizedString(@"VCShareWithTypeSRB", nil) andText1:text1 andText2:text2 andText3:text3 andText4:text4 showNext:NO]];
