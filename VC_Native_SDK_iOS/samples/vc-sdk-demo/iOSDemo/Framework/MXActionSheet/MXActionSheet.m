...
#define MXAS_SCREEN_WIDTH  [UIApplication sharedApplication].keyWindow.frame.size.width //([UIScreen mainScreen].bounds.size.width)
#define MXAS_SCREEN_HEIGHT [UIApplication sharedApplication].keyWindow.frame.size.height//([UIScreen mainScreen].bounds.size.height)
...
- (instancetype)initWithTitle:(NSString *)title
    ...
    if (self) {
        ...
        NSLog(@"MXAS_SCREEN_WIDTH = %f MXAS_SCREEN_HEIGHT = %f",MXAS_SCREEN_WIDTH,MXAS_SCREEN_HEIGHT);
