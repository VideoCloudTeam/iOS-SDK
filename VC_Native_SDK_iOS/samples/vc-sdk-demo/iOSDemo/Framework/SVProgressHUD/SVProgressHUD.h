...
+ (void)setInfoImage:( UIImage* _Nullable)image;                       // default is the bundled info image provided by Freepik
+ (void)setSuccessImage:( UIImage* _Nullable )image;                    // default is the bundled success image provided by Freepik
+ (void)setErrorImage:( UIImage* _Nullable )image;                      // default is the bundled error image provided by Freepik
